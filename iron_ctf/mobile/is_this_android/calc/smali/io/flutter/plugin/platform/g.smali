...
.field private d:Lp2/k$j;

.field private e:I

.field final f:Lp2/k$h;


# direct methods
.method public constructor <init>(Landroid/app/Activity;Lp2/k;Lio/flutter/plugin/platform/g$d;)V
    .locals 1
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/g;->f:Lp2/k$h;

    iput-object p1, p0, Lio/flutter/plugin/platform/g;->a:Landroid/app/Activity;

    iput-object p2, p0, Lio/flutter/plugin/platform/g;->b:Lp2/k;

    invoke-virtual {p2, v0}, Lp2/k;->l(Lp2/k$h;)V
...
.method private C(Lp2/k$j;)V
    ...
    new-instance v2, Landroidx/core/view/i3;

    invoke-direct {v2, v0, v1}, Landroidx/core/view/i3;-><init>(Landroid/view/Window;Landroid/view/View;)V
    ...
    iget-object v3, p1, Lp2/k$j;->b:Lp2/k$d;
    ...
    :cond_1
    invoke-virtual {v2, v4}, Landroidx/core/view/i3;->b(Z)V

    goto :goto_0

    :cond_2
    invoke-virtual {v2, v6}, Landroidx/core/view/i3;->b(Z)V

    :cond_3
    :goto_0
    iget-object v3, p1, Lp2/k$j;->a:Ljava/lang/Integer;
    ...
    :cond_4
    iget-object v3, p1, Lp2/k$j;->c:Ljava/lang/Boolean;
    ...
    iget-object v3, p1, Lp2/k$j;->e:Lp2/k$d;
    ...
    :cond_6
    invoke-virtual {v2, v4}, Landroidx/core/view/i3;->a(Z)V

    goto :goto_1

    :cond_7
    invoke-virtual {v2, v6}, Landroidx/core/view/i3;->a(Z)V

    :cond_8
    :goto_1
    iget-object v2, p1, Lp2/k$j;->d:Ljava/lang/Integer;
    ...
    :cond_9
    iget-object v2, p1, Lp2/k$j;->f:Ljava/lang/Integer;
    ...
    :cond_a
    iget-object v2, p1, Lp2/k$j;->g:Ljava/lang/Boolean;
    ...
    :cond_b
    iput-object p1, p0, Lio/flutter/plugin/platform/g;->d:Lp2/k$j;
...
.method static synthetic a(Lio/flutter/plugin/platform/g;Lp2/k$i;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/g;->s(Lp2/k$i;)V
...
.method static synthetic c(Lio/flutter/plugin/platform/g;Lp2/k$e;)Ljava/lang/CharSequence;
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/g;->r(Lp2/k$e;)Ljava/lang/CharSequence;
...
.method static synthetic g(Lio/flutter/plugin/platform/g;)Lp2/k;
    .locals 0

    iget-object p0, p0, Lio/flutter/plugin/platform/g;->b:Lp2/k;

    return-object p0
.end method

.method static synthetic h(Lio/flutter/plugin/platform/g;Lp2/k$c;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/g;->x(Lp2/k$c;)V
...
.method static synthetic j(Lio/flutter/plugin/platform/g;Lp2/k$k;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/g;->z(Lp2/k$k;)V
...
.method static synthetic m(Lio/flutter/plugin/platform/g;Lp2/k$j;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/g;->C(Lp2/k$j;)V
...
.method private r(Lp2/k$e;)Ljava/lang/CharSequence;
    .locals 6
    ...
    sget-object v2, Lp2/k$e;->g:Lp2/k$e;
    ...
    invoke-static {v0, p1}, Le2/b;->g(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, p1}, Le2/b;->h(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private s(Lp2/k$i;)V
    .locals 1

    sget-object v0, Lp2/k$i;->g:Lp2/k$i;
...
.method private t()V
    ...
    invoke-interface {v0}, Landroidx/activity/s;->k()Landroidx/activity/q;
...
.method private w(Z)V
    ...
    invoke-interface {v0, p1}, Lio/flutter/plugin/platform/g$d;->h(Z)V

    :cond_0
    return-void
.end method

.method private x(Lp2/k$c;)V
    .locals 4
    ...
    iget-object v2, p1, Lp2/k$c;->b:Ljava/lang/String;

    const/4 v3, 0x0

    iget p1, p1, Lp2/k$c;->a:I
    ...
    iget-object v1, p1, Lp2/k$c;->b:Ljava/lang/String;
...
.method private z(Lp2/k$k;)V
    .locals 1

    sget-object v0, Lp2/k$k;->g:Lp2/k$k;
    ...
    :cond_0
    sget-object v0, Lp2/k$k;->h:Lp2/k$k;
    ...
    :cond_1
    sget-object v0, Lp2/k$k;->i:Lp2/k$k;
    ...
    :cond_2
    sget-object v0, Lp2/k$k;->j:Lp2/k$k;
...
.method public E()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/g;->d:Lp2/k$j;

    if-eqz v0, :cond_0

    invoke-direct {p0, v0}, Lio/flutter/plugin/platform/g;->C(Lp2/k$j;)V
...
.method public q()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/g;->b:Lp2/k;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lp2/k;->l(Lp2/k$h;)V
