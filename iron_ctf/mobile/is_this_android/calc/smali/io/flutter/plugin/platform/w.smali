...
.field final i:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap<",
            "Ljava/lang/Integer;",
            "Lio/flutter/plugin/platform/g0;",
            ">;"
        }
    .end annotation
.end field
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/w;->v:Lp2/m$g;

    new-instance v0, Lio/flutter/plugin/platform/l;

    invoke-direct {v0}, Lio/flutter/plugin/platform/l;-><init>()V

    iput-object v0, p0, Lio/flutter/plugin/platform/w;->a:Lio/flutter/plugin/platform/l;
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/w;->t:Lio/flutter/embedding/android/b0;

    return-void
.end method

.method static synthetic A(Lio/flutter/plugin/platform/w;Lio/flutter/plugin/platform/i;Lp2/m$d;)J
    .locals 0

    invoke-direct {p0, p1, p2}, Lio/flutter/plugin/platform/w;->J(Lio/flutter/plugin/platform/i;Lp2/m$d;)J
...
.method private H(Lio/flutter/plugin/platform/i;Lp2/m$d;)V
    .locals 1
    ...
    invoke-static {p2, p1}, Le2/b;->e(Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method private J(Lio/flutter/plugin/platform/i;Lp2/m$d;)J
    .locals 10
    ...
    invoke-static {v0}, Lio/flutter/plugin/platform/w;->e0(Lio/flutter/view/TextureRegistry;)Lio/flutter/plugin/platform/n;

    move-result-object v0

    iget-wide v1, p2, Lp2/m$d;->c:D

    invoke-direct {p0, v1, v2}, Lio/flutter/plugin/platform/w;->y0(D)I

    move-result v5

    iget-wide v1, p2, Lp2/m$d;->d:D
    ...
    iget v7, p2, Lp2/m$d;->a:I

    new-instance v9, Lio/flutter/plugin/platform/u;

    invoke-direct {v9, p0, p2}, Lio/flutter/plugin/platform/u;-><init>(Lio/flutter/plugin/platform/w;Lp2/m$d;)V
    ...
    invoke-static/range {v1 .. v9}, Lio/flutter/plugin/platform/g0;->b(Landroid/content/Context;Lio/flutter/plugin/platform/a;Lio/flutter/plugin/platform/i;Lio/flutter/plugin/platform/n;IIILjava/lang/Object;Landroid/view/View$OnFocusChangeListener;)Lio/flutter/plugin/platform/g0;
    ...
    invoke-interface {v0}, Lio/flutter/plugin/platform/n;->getId()J
    ...
    iget-object v1, p2, Lp2/m$d;->b:Ljava/lang/String;
...
.method private R()V
    ...
    iget-object v1, p0, Lio/flutter/plugin/platform/w;->v:Lp2/m$g;

    invoke-interface {v1, v0}, Lp2/m$g;->h(I)V
...
.method private T(Lp2/m$d;)V
    .locals 3

    iget v0, p1, Lp2/m$d;->g:I
...
.method private U(Z)V
    ...
    iget-object v2, p0, Lio/flutter/plugin/platform/w;->d:Lio/flutter/embedding/android/r;

    invoke-virtual {v2, v4}, Lio/flutter/embedding/android/r;->m(Lio/flutter/embedding/android/j;)V

    invoke-virtual {v4}, Lio/flutter/embedding/android/j;->e()Z
...
.method private Y()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/w;->d:Lio/flutter/embedding/android/r;

    invoke-virtual {v0}, Lio/flutter/embedding/android/r;->p()V
...
.method private synthetic Z(Lp2/m$d;Landroid/view/View;Z)V
    .locals 0

    if-eqz p3, :cond_0

    iget-object p2, p0, Lio/flutter/plugin/platform/w;->g:Lp2/m;

    iget p1, p1, Lp2/m$d;->a:I

    invoke-virtual {p2, p1}, Lp2/m;->d(I)V
...
.method private synthetic a0(Lp2/m$d;Landroid/view/View;Z)V
    .locals 0
...
.method private static e0(Lio/flutter/view/TextureRegistry;)Lio/flutter/plugin/platform/n;
    .locals 3
    ...
    invoke-static {v2, v0}, Le2/b;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static synthetic f(Lio/flutter/plugin/platform/w;Lp2/m$d;Landroid/view/View;Z)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lio/flutter/plugin/platform/w;->a0(Lp2/m$d;Landroid/view/View;Z)V
...
.method public static synthetic g(Lio/flutter/plugin/platform/w;Lp2/m$d;Landroid/view/View;Z)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lio/flutter/plugin/platform/w;->Z(Lp2/m$d;Landroid/view/View;Z)V
...
.method static synthetic j(Lio/flutter/plugin/platform/w;Lp2/m$d;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/w;->T(Lp2/m$d;)V
...
.method private t0()V
    ...
    iget-object v1, p0, Lio/flutter/plugin/platform/w;->d:Lio/flutter/embedding/android/r;
...
.method static synthetic u(Lio/flutter/plugin/platform/w;Lio/flutter/plugin/platform/i;Lp2/m$d;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lio/flutter/plugin/platform/w;->H(Lio/flutter/plugin/platform/i;Lp2/m$d;)V
...
.method static synthetic x(Lio/flutter/plugin/platform/w;)Lio/flutter/embedding/android/r;
    .locals 0

    iget-object p0, p0, Lio/flutter/plugin/platform/w;->d:Lio/flutter/embedding/android/r;
...
# virtual methods
.method public C(Landroid/content/Context;Lio/flutter/view/TextureRegistry;Lf2/a;)V
    .locals 1
    ...
    invoke-direct {p1, p3}, Lp2/m;-><init>(Lf2/a;)V

    iput-object p1, p0, Lio/flutter/plugin/platform/w;->g:Lp2/m;

    iget-object p2, p0, Lio/flutter/plugin/platform/w;->v:Lp2/m$g;

    invoke-virtual {p1, p2}, Lp2/m;->e(Lp2/m$g;)V
...
.method public F(Lio/flutter/embedding/android/r;)V
    .locals 3

    iput-object p1, p0, Lio/flutter/plugin/platform/w;->d:Lio/flutter/embedding/android/r;
...
.method public I(Lio/flutter/plugin/platform/i;Lp2/m$d;)J
    .locals 9
    ...
    invoke-static {v2}, Lio/flutter/plugin/platform/w;->e0(Lio/flutter/view/TextureRegistry;)Lio/flutter/plugin/platform/n;
    ...
    invoke-direct {v3, v4, v2}, Lio/flutter/plugin/platform/p;-><init>(Landroid/content/Context;Lio/flutter/plugin/platform/n;)V

    invoke-interface {v2}, Lio/flutter/plugin/platform/n;->getId()J
    ...
    invoke-virtual {v2, v5}, Lio/flutter/plugin/platform/p;->setTouchProcessor(Lio/flutter/embedding/android/a;)V
    ...
    invoke-direct {v0, p0, p2}, Lio/flutter/plugin/platform/t;-><init>(Lio/flutter/plugin/platform/w;Lp2/m$d;)V
    ...
    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/w;->f0(Lio/flutter/plugin/platform/i;)V
...
.method public K()Lio/flutter/embedding/engine/FlutterOverlaySurface;
    ...
    iget-object v3, p0, Lio/flutter/plugin/platform/w;->d:Lio/flutter/embedding/android/r;
...
.method public M(Lp2/m$d;Z)Lio/flutter/plugin/platform/i;
    .locals 3

    iget-object v0, p0, Lio/flutter/plugin/platform/w;->a:Lio/flutter/plugin/platform/l;

    iget-object v1, p1, Lp2/m$d;->b:Ljava/lang/String;
    ...
    iget-object v2, p1, Lp2/m$d;->i:Ljava/nio/ByteBuffer;

    if-eqz v2, :cond_0

    invoke-virtual {v0}, Lio/flutter/plugin/platform/j;->b()Lq2/g;

    move-result-object v1

    iget-object v2, p1, Lp2/m$d;->i:Ljava/nio/ByteBuffer;

    invoke-interface {v1, v2}, Lq2/g;->b(Ljava/nio/ByteBuffer;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p2}, Lio/flutter/plugin/platform/w;->f0(Lio/flutter/plugin/platform/i;)V
    ...
    iget-object p1, p1, Lp2/m$d;->b:Ljava/lang/String;
...
.method public N()V
    ...
    invoke-virtual {v1}, Lio/flutter/embedding/android/j;->g()V
...
.method public O()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/w;->g:Lp2/m;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    invoke-virtual {v0, v1}, Lp2/m;->e(Lp2/m$g;)V

    :cond_0
    invoke-virtual {p0}, Lio/flutter/plugin/platform/w;->N()V

    iput-object v1, p0, Lio/flutter/plugin/platform/w;->g:Lp2/m;
...
.method public P()V
    ...
    iput-object v1, p0, Lio/flutter/plugin/platform/w;->d:Lio/flutter/embedding/android/r;
...
.method public W()Lio/flutter/plugin/platform/k;
    .locals 1
...
.method X(I)V
    ...
    iget-object p1, p0, Lio/flutter/plugin/platform/w;->d:Lio/flutter/embedding/android/r;
...
.method public l0()V
    ...
    invoke-virtual {v0, v1}, Lio/flutter/embedding/android/r;->A(Ljava/lang/Runnable;)V
...
.method public x0(FLp2/m$f;Z)Landroid/view/MotionEvent;
    .locals 20

    move-object/from16 v0, p2

    iget-wide v1, v0, Lp2/m$f;->p:J
    ...
    iget-object v3, v2, Lio/flutter/plugin/platform/w;->t:Lio/flutter/embedding/android/b0;

    invoke-virtual {v3, v1}, Lio/flutter/embedding/android/b0;->b(Lio/flutter/embedding/android/b0$a;)Landroid/view/MotionEvent;

    move-result-object v1

    iget-object v3, v0, Lp2/m$f;->g:Ljava/lang/Object;
    ...
    iget-object v1, v0, Lp2/m$f;->b:Ljava/lang/Number;

    invoke-virtual {v1}, Ljava/lang/Number;->longValue()J

    move-result-wide v4

    iget-object v1, v0, Lp2/m$f;->c:Ljava/lang/Number;

    invoke-virtual {v1}, Ljava/lang/Number;->longValue()J

    move-result-wide v6

    iget v8, v0, Lp2/m$f;->d:I

    iget v9, v0, Lp2/m$f;->e:I

    iget v12, v0, Lp2/m$f;->h:I

    iget v13, v0, Lp2/m$f;->i:I

    iget v14, v0, Lp2/m$f;->j:F

    iget v15, v0, Lp2/m$f;->k:F

    iget v1, v0, Lp2/m$f;->l:I

    iget v3, v0, Lp2/m$f;->m:I

    iget v2, v0, Lp2/m$f;->n:I

    iget v0, v0, Lp2/m$f;->o:I
