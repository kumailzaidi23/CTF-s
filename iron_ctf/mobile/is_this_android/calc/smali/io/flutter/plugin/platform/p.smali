...
.method public constructor <init>(Landroid/content/Context;Lio/flutter/plugin/platform/n;)V
    .locals 2

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/p;-><init>(Landroid/content/Context;)V

    iput-object p2, p0, Lio/flutter/plugin/platform/p;->k:Lio/flutter/plugin/platform/n;

    invoke-interface {p2}, Lio/flutter/plugin/platform/n;->getSurface()Landroid/view/Surface;
    ...
    invoke-static {p1}, Lio/flutter/plugin/platform/o;->a(Landroid/view/Surface;)Landroid/graphics/Canvas;
...
.method public a()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/p;->k:Lio/flutter/plugin/platform/n;
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/p;->k:Lio/flutter/plugin/platform/n;
...
.method public b(II)V
    ...
    invoke-interface {v0, p1, p2}, Lio/flutter/plugin/platform/n;->a(II)V
...
.method public c()V
    ...
    iget-object v1, p0, Lio/flutter/plugin/platform/p;->l:Landroid/view/ViewTreeObserver$OnGlobalFocusChangeListener;

    if-eqz v1, :cond_0

    const/4 v2, 0x0

    iput-object v2, p0, Lio/flutter/plugin/platform/p;->l:Landroid/view/ViewTreeObserver$OnGlobalFocusChangeListener;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    :cond_0
    invoke-interface {v0}, Lio/flutter/plugin/platform/n;->getSurface()Landroid/view/Surface;
    ...
    iget-object v1, p0, Lio/flutter/plugin/platform/p;->k:Lio/flutter/plugin/platform/n;

    invoke-interface {v1}, Lio/flutter/plugin/platform/n;->scheduleFrame()V
    ...
    iget-object v2, p0, Lio/flutter/plugin/platform/p;->k:Lio/flutter/plugin/platform/n;

    invoke-interface {v2}, Lio/flutter/plugin/platform/n;->scheduleFrame()V
...
.method public getActiveFocusListener()Landroid/view/ViewTreeObserver$OnGlobalFocusChangeListener;
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/p;->l:Landroid/view/ViewTreeObserver$OnGlobalFocusChangeListener;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/p;->j:Lio/flutter/embedding/android/a;
    ...
    iget v1, p0, Lio/flutter/plugin/platform/p;->h:I

    int-to-float v1, v1

    iget v2, p0, Lio/flutter/plugin/platform/p;->i:I

    goto :goto_0

    :cond_1
    iget v1, p0, Lio/flutter/plugin/platform/p;->f:I

    int-to-float v1, v1

    iget v2, p0, Lio/flutter/plugin/platform/p;->g:I
    ...
    iput v1, p0, Lio/flutter/plugin/platform/p;->f:I

    iget v1, p0, Lio/flutter/plugin/platform/p;->i:I

    iput v1, p0, Lio/flutter/plugin/platform/p;->g:I
    ...
    iput v2, p0, Lio/flutter/plugin/platform/p;->g:I
    ...
    :goto_1
    iget-object v1, p0, Lio/flutter/plugin/platform/p;->j:Lio/flutter/embedding/android/a;
...
.method public setLayoutParams(Landroid/widget/FrameLayout$LayoutParams;)V
    ...
    iput v0, p0, Lio/flutter/plugin/platform/p;->h:I

    iget p1, p1, Landroid/widget/FrameLayout$LayoutParams;->topMargin:I

    iput p1, p0, Lio/flutter/plugin/platform/p;->i:I
...
.method public setOnDescendantFocusChangeListener(Landroid/view/View$OnFocusChangeListener;)V
    ...
    iput-object v1, p0, Lio/flutter/plugin/platform/p;->l:Landroid/view/ViewTreeObserver$OnGlobalFocusChangeListener;
...
.method public setTouchProcessor(Lio/flutter/embedding/android/a;)V
    ...
    iput-object p1, p0, Lio/flutter/plugin/platform/p;->j:Lio/flutter/embedding/android/a;
