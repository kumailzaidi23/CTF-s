...
.method private e(Lio/flutter/embedding/engine/d$b;)Lio/flutter/embedding/engine/d$b;
    ...
    invoke-virtual {v0}, Lh2/d;->g()Ljava/lang/String;
    ...
    :cond_2
    invoke-virtual {p1, v1}, Lio/flutter/embedding/engine/d$b;->i(Lf2/a$b;)Lio/flutter/embedding/engine/d$b;
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/e$c;->m()Ljava/util/List;
...
.method private j(Lio/flutter/embedding/android/r;)V
    .locals 2

    iget-object v0, p0, Lio/flutter/embedding/android/e;->a:Lio/flutter/embedding/android/e$c;

    invoke-interface {v0}, Lio/flutter/embedding/android/e$c;->A()Lio/flutter/embedding/android/c0;

    move-result-object v0

    sget-object v1, Lio/flutter/embedding/android/c0;->f:Lio/flutter/embedding/android/c0;
...
.method private k()V
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/e$c;->q()Ljava/lang/String;
    ...
    invoke-interface {v3}, Lio/flutter/embedding/android/e$c;->s()Ljava/lang/String;
    ...
    invoke-static {v3, v2}, Le2/b;->f(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v2, p0, Lio/flutter/embedding/android/e;->b:Lio/flutter/embedding/engine/a;

    invoke-virtual {v2}, Lio/flutter/embedding/engine/a;->o()Lp2/j;

    move-result-object v2

    invoke-virtual {v2, v0}, Lp2/j;->c(Ljava/lang/String;)V
    ...
    invoke-interface {v2}, Lio/flutter/embedding/android/e$c;->m()Ljava/util/List;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Lf2/a;->g(Lf2/a$b;Ljava/util/List;)V
...
.method private q(Landroid/content/Intent;)Ljava/lang/String;
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/e$c;->y()Z
...
.method A(I[Ljava/lang/String;[I)V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->i()Lk2/b;

    move-result-object v0

    invoke-interface {v0, p1, p2, p3}, Lk2/b;->b(I[Ljava/lang/String;[I)Z
...
.method B(Landroid/os/Bundle;)V
    ...
    invoke-interface {v1}, Lio/flutter/embedding/android/e$c;->r()Z
    ...
    invoke-virtual {v1}, Lio/flutter/embedding/engine/a;->u()Lp2/o;

    move-result-object v1

    invoke-virtual {v1, v0}, Lp2/o;->j([B)V
    ...
    invoke-interface {v0, p1}, Lk2/b;->d(Landroid/os/Bundle;)V
...
.method C()V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->l()Lp2/g;

    move-result-object v0

    invoke-virtual {v0}, Lp2/g;->e()V
...
.method D(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->u()Lp2/o;

    move-result-object v0

    invoke-virtual {v0}, Lp2/o;->h()[B
    ...
    invoke-virtual {v1}, Lio/flutter/embedding/engine/a;->i()Lk2/b;
...
.method G(I)V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->x()Lp2/r;

    move-result-object v0

    invoke-virtual {v0}, Lp2/r;->a()V
...
.method J()V
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/e;->d:Lio/flutter/plugin/platform/g;
...
.method K()V
    ...
    invoke-interface {v1}, Lio/flutter/embedding/android/e$c;->a()Landroid/content/Context;

    move-result-object v4

    invoke-interface {v1, v4}, Lio/flutter/embedding/android/e$c;->C(Landroid/content/Context;)Lio/flutter/embedding/engine/a;
    ...
    invoke-interface {v2}, Lio/flutter/embedding/android/e$c;->a()Landroid/content/Context;
    ...
    :goto_0
    invoke-direct {p0, v1}, Lio/flutter/embedding/android/e;->e(Lio/flutter/embedding/engine/d$b;)Lio/flutter/embedding/engine/d$b;
    ...
    invoke-interface {v2}, Lio/flutter/embedding/android/e$c;->z()Lio/flutter/embedding/engine/g;
    ...
    invoke-interface {v2}, Lio/flutter/embedding/android/e$c;->r()Z
...
.method L(Landroid/window/BackEvent;)V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->j()Lp2/b;

    move-result-object v0

    invoke-virtual {v0, p1}, Lp2/b;->d(Landroid/window/BackEvent;)V
...
.method M(Landroid/window/BackEvent;)V
    ...
    invoke-virtual {v0, p1}, Lp2/b;->e(Landroid/window/BackEvent;)V
...
.method N()V
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/e;->d:Lio/flutter/plugin/platform/g;
...
.method s(Landroid/content/Context;)V
    ...
    invoke-interface {p1}, Lio/flutter/embedding/android/e$c;->n()Z
    ...
    invoke-virtual {p1}, Lio/flutter/embedding/engine/a;->i()Lk2/b;

    move-result-object p1

    iget-object v0, p0, Lio/flutter/embedding/android/e;->a:Lio/flutter/embedding/android/e$c;

    invoke-interface {v0}, Lio/flutter/embedding/android/e$c;->b()Landroidx/lifecycle/i;

    move-result-object v0

    invoke-interface {p1, p0, v0}, Lk2/b;->g(Lio/flutter/embedding/android/b;Landroidx/lifecycle/i;)V
    ...
    invoke-interface {p1, v0, v1}, Lio/flutter/embedding/android/e$c;->v(Landroid/app/Activity;Lio/flutter/embedding/engine/a;)Lio/flutter/plugin/platform/g;

    move-result-object p1

    iput-object p1, p0, Lio/flutter/embedding/android/e;->d:Lio/flutter/plugin/platform/g;

    iget-object p1, p0, Lio/flutter/embedding/android/e;->a:Lio/flutter/embedding/android/e$c;

    iget-object v0, p0, Lio/flutter/embedding/android/e;->b:Lio/flutter/embedding/engine/a;

    invoke-interface {p1, v0}, Lio/flutter/embedding/android/e$c;->F(Lio/flutter/embedding/engine/a;)V
...
.method t()V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->o()Lp2/j;

    move-result-object v0

    invoke-virtual {v0}, Lp2/j;->a()V
...
.method u(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;IZ)Landroid/view/View;
    ...
    invoke-interface {p2}, Lio/flutter/embedding/android/e$c;->A()Lio/flutter/embedding/android/c0;

    move-result-object p2

    sget-object p3, Lio/flutter/embedding/android/c0;->f:Lio/flutter/embedding/android/c0;
    ...
    invoke-interface {p3}, Lio/flutter/embedding/android/e$c;->a()Landroid/content/Context;

    move-result-object p3

    iget-object v2, p0, Lio/flutter/embedding/android/e;->a:Lio/flutter/embedding/android/e$c;

    invoke-interface {v2}, Lio/flutter/embedding/android/e$c;->D()Lio/flutter/embedding/android/d0;

    move-result-object v2

    sget-object v3, Lio/flutter/embedding/android/d0;->g:Lio/flutter/embedding/android/d0;
    ...
    invoke-interface {p3, p2}, Lio/flutter/embedding/android/e$c;->w(Lio/flutter/embedding/android/k;)V

    new-instance p3, Lio/flutter/embedding/android/r;

    iget-object v0, p0, Lio/flutter/embedding/android/e;->a:Lio/flutter/embedding/android/e$c;

    invoke-interface {v0}, Lio/flutter/embedding/android/e$c;->a()Landroid/content/Context;
    ...
    invoke-interface {p3}, Lio/flutter/embedding/android/e$c;->D()Lio/flutter/embedding/android/d0;

    move-result-object p3

    sget-object v2, Lio/flutter/embedding/android/d0;->f:Lio/flutter/embedding/android/d0;
    ...
    invoke-interface {p3, p2}, Lio/flutter/embedding/android/e$c;->E(Lio/flutter/embedding/android/l;)V
    ...
    invoke-virtual {p2, p3}, Lio/flutter/embedding/android/r;->l(Lio/flutter/embedding/engine/renderer/d;)V

    iget-object p2, p0, Lio/flutter/embedding/android/e;->a:Lio/flutter/embedding/android/e$c;

    invoke-interface {p2}, Lio/flutter/embedding/android/e$c;->B()Z
    ...
    invoke-virtual {p1, p2}, Lio/flutter/embedding/android/r;->n(Lio/flutter/embedding/engine/a;)V
    ...
    invoke-direct {p0, p1}, Lio/flutter/embedding/android/e;->j(Lio/flutter/embedding/android/r;)V
...
.method v()V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/android/r;->s()V

    iget-object v0, p0, Lio/flutter/embedding/android/e;->c:Lio/flutter/embedding/android/r;

    iget-object v1, p0, Lio/flutter/embedding/android/e;->l:Lio/flutter/embedding/engine/renderer/d;

    invoke-virtual {v0, v1}, Lio/flutter/embedding/android/r;->y(Lio/flutter/embedding/engine/renderer/d;)V
...
.method w()V
    ...
    invoke-interface {v1}, Lio/flutter/embedding/android/e$c;->n()Z
    ...
    iput-object v1, p0, Lio/flutter/embedding/android/e;->d:Lio/flutter/plugin/platform/g;
...
.method x(Landroid/content/Intent;)V
    ...
    invoke-interface {v0, p1}, Lk2/b;->c(Landroid/content/Intent;)V
    ...
    invoke-virtual {v0, p1}, Lp2/j;->b(Ljava/lang/String;)V
