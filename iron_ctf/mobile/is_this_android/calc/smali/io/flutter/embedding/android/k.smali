...
.field private final k:Lio/flutter/embedding/engine/renderer/d;
...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Z)V
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/k;->j:Landroid/view/SurfaceHolder$Callback;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/k;->k:Lio/flutter/embedding/engine/renderer/d;

    iput-boolean p3, p0, Lio/flutter/embedding/android/k;->f:Z

    invoke-direct {p0}, Lio/flutter/embedding/android/k;->n()V
...
.method static synthetic e(Lio/flutter/embedding/android/k;Z)Z
    .locals 0
...
.method static synthetic f(Lio/flutter/embedding/android/k;)Z
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/android/k;->p()Z
...
.method static synthetic h(Lio/flutter/embedding/android/k;II)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lio/flutter/embedding/android/k;->k(II)V

    return-void
.end method

.method static synthetic i(Lio/flutter/embedding/android/k;)V
    .locals 0
...
.method static synthetic j(Lio/flutter/embedding/android/k;)Lio/flutter/embedding/engine/renderer/FlutterRenderer;
    .locals 0

    iget-object p0, p0, Lio/flutter/embedding/android/k;->i:Lio/flutter/embedding/engine/renderer/FlutterRenderer;
...
.method private k(II)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/k;->i:Lio/flutter/embedding/engine/renderer/FlutterRenderer;
...
.method private l()V
    ...
    iget-boolean v2, p0, Lio/flutter/embedding/android/k;->h:Z
...
.method private n()V
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/k;->j:Landroid/view/SurfaceHolder$Callback;
...
.method public a()V
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/k;->k:Lio/flutter/embedding/engine/renderer/d;

    invoke-virtual {v0, v1}, Lio/flutter/embedding/engine/renderer/FlutterRenderer;->u(Lio/flutter/embedding/engine/renderer/d;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lio/flutter/embedding/android/k;->i:Lio/flutter/embedding/engine/renderer/FlutterRenderer;
...
.method public b()V
    ...
    :cond_0
    iget-object v2, p0, Lio/flutter/embedding/android/k;->k:Lio/flutter/embedding/engine/renderer/d;

    invoke-virtual {v0, v2}, Lio/flutter/embedding/engine/renderer/FlutterRenderer;->j(Lio/flutter/embedding/engine/renderer/d;)V

    invoke-virtual {p0}, Lio/flutter/embedding/android/k;->o()Z
...
.method public c(Lio/flutter/embedding/engine/renderer/FlutterRenderer;)V
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/k;->i:Lio/flutter/embedding/engine/renderer/FlutterRenderer;
    ...
    :cond_0
    iput-object p1, p0, Lio/flutter/embedding/android/k;->i:Lio/flutter/embedding/engine/renderer/FlutterRenderer;
