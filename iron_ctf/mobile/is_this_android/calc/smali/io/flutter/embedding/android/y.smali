...
.method public constructor <init>(Lq2/b;)V
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/y;->a:Lq2/b;
...
.method private static e(Landroid/view/KeyEvent;)Lio/flutter/embedding/android/u$b;
    .locals 2
    ...
    sget-object p0, Lio/flutter/embedding/android/u$b;->h:Lio/flutter/embedding/android/u$b;
    ...
    sget-object p0, Lio/flutter/embedding/android/u$b;->i:Lio/flutter/embedding/android/u$b;

    goto :goto_1

    :cond_3
    sget-object p0, Lio/flutter/embedding/android/u$b;->g:Lio/flutter/embedding/android/u$b;
...
.method private i(Landroid/view/KeyEvent;Lio/flutter/embedding/android/z$d$a;)Z
    ...
    :goto_5
    sget-object v0, Lio/flutter/embedding/android/u$b;->g:Lio/flutter/embedding/android/u$b;
    ...
    sget-object v0, Lio/flutter/embedding/android/u$b;->i:Lio/flutter/embedding/android/u$b;
    ...
    :cond_a
    sget-object v0, Lio/flutter/embedding/android/u$b;->h:Lio/flutter/embedding/android/u$b;

    :cond_b
    move-object v1, v8

    :goto_7
    sget-object v2, Lio/flutter/embedding/android/u$b;->i:Lio/flutter/embedding/android/u$b;
    ...
    :cond_d
    sget-object v2, Lio/flutter/embedding/android/u$b;->g:Lio/flutter/embedding/android/u$b;
    ...
    sget-object v3, Lio/flutter/embedding/android/u$a;->g:Lio/flutter/embedding/android/u$a;

    :goto_8
    iput-object v3, v2, Lio/flutter/embedding/android/u;->f:Lio/flutter/embedding/android/u$a;

    goto :goto_9

    :cond_f
    sget-object v3, Lio/flutter/embedding/android/u$a;->k:Lio/flutter/embedding/android/u$a;

    goto :goto_8

    :cond_10
    sget-object v3, Lio/flutter/embedding/android/u$a;->j:Lio/flutter/embedding/android/u$a;

    goto :goto_8

    :cond_11
    sget-object v3, Lio/flutter/embedding/android/u$a;->i:Lio/flutter/embedding/android/u$a;

    goto :goto_8

    :cond_12
    sget-object v3, Lio/flutter/embedding/android/u$a;->h:Lio/flutter/embedding/android/u$a;
    ...
    iput-object v0, v2, Lio/flutter/embedding/android/u;->b:Lio/flutter/embedding/android/u$b;
    ...
    iput-object v1, v2, Lio/flutter/embedding/android/u;->g:Ljava/lang/String;

    iput-boolean v10, v2, Lio/flutter/embedding/android/u;->e:Z

    sget-object v0, Lio/flutter/embedding/android/u$a;->g:Lio/flutter/embedding/android/u$a;

    iput-object v0, v2, Lio/flutter/embedding/android/u;->f:Lio/flutter/embedding/android/u$a;
...
.method private static synthetic k(Lio/flutter/embedding/android/z$d$a;Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {p1, v1}, Le2/b;->g(Ljava/lang/String;Ljava/lang/String;)V
...
.method private n(Lio/flutter/embedding/android/u;Lio/flutter/embedding/android/z$d$a;)V
    ...
    :goto_0
    iget-object v0, p0, Lio/flutter/embedding/android/y;->a:Lq2/b;
...
.method private q(ZLjava/lang/Long;Ljava/lang/Long;J)V
    ...
    sget-object p4, Lio/flutter/embedding/android/u$b;->g:Lio/flutter/embedding/android/u$b;

    goto :goto_0

    :cond_0
    sget-object p4, Lio/flutter/embedding/android/u$b;->h:Lio/flutter/embedding/android/u$b;

    :goto_0
    iput-object p4, v0, Lio/flutter/embedding/android/u;->b:Lio/flutter/embedding/android/u$b;
    ...
    iput-object p4, v0, Lio/flutter/embedding/android/u;->g:Ljava/lang/String;

    const/4 p5, 0x1

    iput-boolean p5, v0, Lio/flutter/embedding/android/u;->e:Z

    sget-object p5, Lio/flutter/embedding/android/u$a;->g:Lio/flutter/embedding/android/u$a;

    iput-object p5, v0, Lio/flutter/embedding/android/u;->f:Lio/flutter/embedding/android/u$a;
...
.method o(Lio/flutter/embedding/android/a0$d;ZJJLandroid/view/KeyEvent;Ljava/util/ArrayList;)V
    ...
    invoke-static/range {p7 .. p7}, Lio/flutter/embedding/android/y;->e(Landroid/view/KeyEvent;)Lio/flutter/embedding/android/u$b;
