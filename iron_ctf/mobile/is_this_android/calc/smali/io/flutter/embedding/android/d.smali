...
.field protected g:Lio/flutter/embedding/android/e;
...
.method static constructor <clinit>()V
    ...
    sput v0, Lio/flutter/embedding/android/d;->j:I
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lio/flutter/embedding/android/d;->f:Z
    ...
    :cond_0
    invoke-direct {p0}, Lio/flutter/embedding/android/d;->L()Landroid/window/OnBackInvokedCallback;

    move-result-object v0

    :goto_0
    iput-object v0, p0, Lio/flutter/embedding/android/d;->i:Landroid/window/OnBackInvokedCallback;

    new-instance v0, Landroidx/lifecycle/n;

    invoke-direct {v0, p0}, Landroidx/lifecycle/n;-><init>(Landroidx/lifecycle/m;)V

    iput-object v0, p0, Lio/flutter/embedding/android/d;->h:Landroidx/lifecycle/n;
...
.method private J()V
    ...
    invoke-virtual {p0}, Lio/flutter/embedding/android/d;->M()Lio/flutter/embedding/android/f;
...
.method private K()Landroid/view/View;
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/d;->g:Lio/flutter/embedding/android/e;

    sget v4, Lio/flutter/embedding/android/d;->j:I

    invoke-virtual {p0}, Lio/flutter/embedding/android/d;->A()Lio/flutter/embedding/android/c0;

    move-result-object v1

    sget-object v2, Lio/flutter/embedding/android/c0;->f:Lio/flutter/embedding/android/c0;
...
.method private L()Landroid/window/OnBackInvokedCallback;
    .locals 2
...
.method private T(Ljava/lang/String;)Z
    ...
    invoke-static {v4, p1}, Le2/b;->g(Ljava/lang/String;Ljava/lang/String;)V
...
.method private U()V
    ...
    :try_start_0
    invoke-virtual {p0}, Lio/flutter/embedding/android/d;->O()Landroid/os/Bundle;
...
# virtual methods
.method public A()Lio/flutter/embedding/android/c0;
    .locals 2
    ...
    sget-object v0, Lio/flutter/embedding/android/c0;->f:Lio/flutter/embedding/android/c0;

    goto :goto_0

    :cond_0
    sget-object v0, Lio/flutter/embedding/android/c0;->g:Lio/flutter/embedding/android/c0;
...
.method public D()Lio/flutter/embedding/android/d0;
    ...
    sget-object v0, Lio/flutter/embedding/android/d0;->f:Lio/flutter/embedding/android/d0;

    goto :goto_0

    :cond_0
    sget-object v0, Lio/flutter/embedding/android/d0;->g:Lio/flutter/embedding/android/d0;

    :goto_0
    return-object v0
.end method

.method public E(Lio/flutter/embedding/android/l;)V
    .locals 0
...
.method public G()V
    ...
    invoke-direct {p0, v0}, Lio/flutter/embedding/android/d;->T(Ljava/lang/String;)Z
...
.method protected M()Lio/flutter/embedding/android/f;
    .locals 2
    ...
    :cond_0
    sget-object v0, Lio/flutter/embedding/android/f;->f:Lio/flutter/embedding/android/f;

    return-object v0
.end method

.method protected N()Lio/flutter/embedding/engine/a;
    .locals 1
...
.method public Q()V
    ...
    iget-object v2, p0, Lio/flutter/embedding/android/d;->i:Landroid/window/OnBackInvokedCallback;
...
.method public R()V
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/d;->g:Lio/flutter/embedding/android/e;
...
.method public V()V
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/d;->i:Landroid/window/OnBackInvokedCallback;
...
.method public b()Landroidx/lifecycle/i;
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/d;->h:Landroidx/lifecycle/n;
...
.method public f()V
    ...
    invoke-virtual {p0}, Lio/flutter/embedding/android/d;->N()Lio/flutter/embedding/engine/a;
...
.method public h(Z)V
    ...
    iget-boolean p1, p0, Lio/flutter/embedding/android/d;->f:Z
...
.method public o()Z
    ...
    invoke-virtual {p0}, Lio/flutter/embedding/android/d;->q()Ljava/lang/String;

    move-result-object v2

    if-nez v2, :cond_1

    iget-object v2, p0, Lio/flutter/embedding/android/d;->g:Lio/flutter/embedding/android/e;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0}, Lio/flutter/embedding/android/d;->U()V
    ...
    iget-object p1, p0, Lio/flutter/embedding/android/d;->h:Landroidx/lifecycle/n;
    ...
    invoke-direct {p0}, Lio/flutter/embedding/android/d;->K()Landroid/view/View;
...
.method public v(Landroid/app/Activity;Lio/flutter/embedding/engine/a;)Lio/flutter/plugin/platform/g;
    .locals 1
    ...
    invoke-virtual {p2}, Lio/flutter/embedding/engine/a;->p()Lp2/k;

    move-result-object p2

    invoke-direct {p1, v0, p2, p0}, Lio/flutter/plugin/platform/g;-><init>(Landroid/app/Activity;Lp2/k;Lio/flutter/plugin/platform/g$d;)V
...
.method public x()Ljava/lang/String;
    ...
    invoke-direct {p0}, Lio/flutter/embedding/android/d;->P()Z
...
.method public z()Lio/flutter/embedding/engine/g;
    .locals 1
