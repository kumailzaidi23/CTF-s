...
.method public getAccessibilityNodeProvider(Landroid/view/View;)Landroid/view/accessibility/AccessibilityNodeProvider;
    ...
    invoke-virtual {v0, p1}, Landroidx/core/view/a;->b(Landroid/view/View;)Lz/r;

    move-result-object p1

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lz/r;->e()Ljava/lang/Object;
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/View;Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-static {p1}, Landroidx/core/view/r0;->X(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v0, v1}, Lz/n;->A0(Z)V

    invoke-static {p1}, Landroidx/core/view/r0;->S(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v0, v1}, Lz/n;->s0(Z)V

    invoke-static {p1}, Landroidx/core/view/r0;->q(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Lz/n;->x0(Ljava/lang/CharSequence;)V

    invoke-static {p1}, Landroidx/core/view/r0;->K(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Lz/n;->E0(Ljava/lang/CharSequence;)V

    iget-object v1, p0, Landroidx/core/view/a$a;->a:Landroidx/core/view/a;

    invoke-virtual {v1, p1, v0}, Landroidx/core/view/a;->g(Landroid/view/View;Lz/n;)V

    invoke-virtual {p2}, Landroid/view/accessibility/AccessibilityNodeInfo;->getText()Ljava/lang/CharSequence;

    move-result-object p2

    invoke-virtual {v0, p2, p1}, Lz/n;->e(Ljava/lang/CharSequence;Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Lz/n;->b(Lz/n$a;)V
