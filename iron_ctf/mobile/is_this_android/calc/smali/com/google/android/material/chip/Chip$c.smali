...
.method constructor <init>(Lcom/google/android/material/chip/Chip;Lcom/google/android/material/chip/Chip;)V
    ...
    invoke-direct {p0, p2}, Lf0/a;-><init>(Landroid/view/View;)V
...
.method protected M(Lz/n;)V
    ...
    invoke-virtual {p1, v0}, Lz/n;->h0(Z)V
    ...
    invoke-virtual {p1, v0}, Lz/n;->k0(Z)V
    ...
    invoke-virtual {p1, v0}, Lz/n;->j0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v0}, Lz/n;->F0(Ljava/lang/CharSequence;)V

    goto :goto_0

    :cond_0
    invoke-virtual {p1, v0}, Lz/n;->n0(Ljava/lang/CharSequence;)V

    :goto_0
    return-void
.end method

.method protected N(ILz/n;)V
    .locals 6
    ...
    :goto_0
    invoke-virtual {p2, p1}, Lz/n;->n0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, p1}, Lz/n;->f0(Landroid/graphics/Rect;)V

    sget-object p1, Lz/n$a;->i:Lz/n$a;

    invoke-virtual {p2, p1}, Lz/n;->b(Lz/n$a;)V
    ...
    invoke-virtual {p2, p1}, Lz/n;->o0(Z)V

    goto :goto_2

    :cond_2
    invoke-virtual {p2, v0}, Lz/n;->n0(Ljava/lang/CharSequence;)V
