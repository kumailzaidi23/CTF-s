...
.method public g(Landroid/view/View;Lz/n;)V
    ...
    invoke-virtual {v8, p2}, Lcom/google/android/material/textfield/a0;->v(Lz/n;)V

    const-string v8, ", "

    if-eqz v6, :cond_4

    invoke-virtual {p2, v0}, Lz/n;->F0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, v1}, Lz/n;->F0(Ljava/lang/CharSequence;)V
    ...
    :goto_4
    invoke-virtual {p2, v3}, Lz/n;->F0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, v1}, Lz/n;->t0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, v1}, Lz/n;->C0(Z)V
    ...
    :goto_7
    invoke-virtual {p2, v4}, Lz/n;->v0(I)V
    ...
    :goto_8
    invoke-virtual {p2, v2}, Lz/n;->p0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0}, Lcom/google/android/material/textfield/v;->s()Landroid/view/View;

    move-result-object v0

    if-eqz v0, :cond_d

    invoke-virtual {p2, v0}, Lz/n;->u0(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/google/android/material/textfield/t;->o(Landroid/view/View;Lz/n;)V
