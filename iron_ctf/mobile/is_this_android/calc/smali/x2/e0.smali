...
.method public static final e(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_0
    invoke-static {p0}, Lx2/d0;->c(Ljava/util/Map;)Ljava/util/Map;
...
.method public static g(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lx2/e0;->h(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lx2/d0;->b(Lw2/j;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lx2/e0;->h(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-static {p0}, Lx2/e0;->e(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final h(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1, p0}, Lx2/e0;->f(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static i(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lx2/e0;->j(Ljava/util/Map;)Ljava/util/Map;
