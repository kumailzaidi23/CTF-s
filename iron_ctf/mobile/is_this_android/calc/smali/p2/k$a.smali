...
# instance fields
.field final synthetic a:Lp2/k;


# direct methods
.method constructor <init>(Lp2/k;)V
    .locals 0

    iput-object p1, p0, Lp2/k$a;->a:Lp2/k;
...
.method public a(Lq2/h;Lq2/i$d;)V
    ...
    iget-object v1, p0, Lp2/k$a;->a:Lp2/k;

    invoke-static {v1}, Lp2/k;->a(Lp2/k;)Lp2/k$h;
    ...
    invoke-interface {v1, p1}, Lp2/k$h;->n(Ljava/lang/String;)V

    :cond_2
    :goto_1
    invoke-interface {p2, v3}, Lq2/i$d;->c(Ljava/lang/Object;)V

    goto/16 :goto_8

    :pswitch_1
    iget-object p1, p0, Lp2/k$a;->a:Lp2/k;

    invoke-static {p1}, Lp2/k;->a(Lp2/k;)Lp2/k$h;

    move-result-object p1

    invoke-interface {p1}, Lp2/k$h;->o()Z
    ...
    invoke-interface {v1, p1}, Lp2/k$h;->g(Ljava/lang/String;)V
    ...
    :try_start_2
    invoke-static {p1}, Lp2/k$e;->b(Ljava/lang/String;)Lp2/k$e;
    ...
    invoke-interface {p2, v0, p1, v3}, Lq2/i$d;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    :cond_3
    move-object p1, v3

    :goto_2
    iget-object v2, p0, Lp2/k$a;->a:Lp2/k;

    invoke-static {v2}, Lp2/k;->a(Lp2/k;)Lp2/k$h;

    move-result-object v2

    invoke-interface {v2, p1}, Lp2/k$h;->a(Lp2/k$e;)Ljava/lang/CharSequence;
    ...
    invoke-interface {p2, v2}, Lq2/i$d;->c(Ljava/lang/Object;)V
    ...
    invoke-interface {p1}, Lp2/k$h;->c()V
    ...
    invoke-interface {v1, p1}, Lp2/k$h;->h(Z)V
    :try_end_3
    ...
    invoke-static {v1, p1}, Lp2/k;->f(Lp2/k;Lorg/json/JSONObject;)Lp2/k$j;
    ...
    invoke-interface {v1, p1}, Lp2/k$h;->l(Lp2/k$j;)V
    ...
    invoke-interface {p1}, Lp2/k$h;->f()V
    ...
    invoke-interface {p1}, Lp2/k$h;->e()V
    :try_end_5
    ...
    invoke-static {v1, p1}, Lp2/k;->e(Lp2/k;Ljava/lang/String;)Lp2/k$k;
    ...
    invoke-interface {v1, p1}, Lp2/k$h;->i(Lp2/k$k;)V
    ...
    invoke-static {v1, p1}, Lp2/k;->d(Lp2/k;Lorg/json/JSONArray;)Ljava/util/List;
    ...
    invoke-interface {v1, p1}, Lp2/k$h;->b(Ljava/util/List;)V
    ...
    invoke-static {v1, p1}, Lp2/k;->c(Lp2/k;Lorg/json/JSONObject;)Lp2/k$c;
    ...
    invoke-interface {v1, p1}, Lp2/k$h;->d(Lp2/k$c;)V
    ...
    invoke-static {v1, p1}, Lp2/k;->b(Lp2/k;Lorg/json/JSONArray;)I
    ...
    invoke-interface {v1, p1}, Lp2/k$h;->j(I)V
    ...
    invoke-static {p1}, Lp2/k$g;->b(Ljava/lang/String;)Lp2/k$g;
    ...
    invoke-interface {v1, p1}, Lp2/k$h;->k(Lp2/k$g;)V
    ...
    invoke-static {p1}, Lp2/k$i;->b(Ljava/lang/String;)Lp2/k$i;
    ...
    invoke-interface {v1, p1}, Lp2/k$h;->m(Lp2/k$i;)V
