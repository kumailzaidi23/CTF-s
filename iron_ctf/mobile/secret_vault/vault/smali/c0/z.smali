...
.method public static final e(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_0
    invoke-static {p0}, Lc0/y;->c(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_1
    invoke-static {}, Lc0/z;->d()Ljava/util/Map;
...
.method public static g(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lc0/z;->h(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lc0/y;->b(Lb0/j;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lc0/z;->h(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-static {p0}, Lc0/z;->e(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final h(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1, p0}, Lc0/z;->f(Ljava/util/Map;Ljava/lang/Iterable;)V
