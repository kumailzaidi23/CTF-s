...
.method public a(Lx/h;Lx/i$d;)V
    ...
    iget-object v1, p0, Lw/j$a;->a:Lw/j;

    invoke-static {v1}, Lw/j;->a(Lw/j;)Lw/j$h;
    ...
    :pswitch_0
    iget-object p1, p0, Lw/j$a;->a:Lw/j;

    invoke-static {p1}, Lw/j;->a(Lw/j;)Lw/j$h;

    move-result-object p1

    invoke-interface {p1}, Lw/j$h;->l()Z
    ...
    invoke-interface {v1, p1}, Lw/j$h;->d(Ljava/lang/String;)V

    :cond_2
    :goto_1
    invoke-interface {p2, v3}, Lx/i$d;->b(Ljava/lang/Object;)V
    ...
    :try_start_2
    invoke-static {p1}, Lw/j$e;->a(Ljava/lang/String;)Lw/j$e;
    ...
    invoke-interface {p2, v0, p1, v3}, Lx/i$d;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    :cond_3
    move-object p1, v3

    :goto_2
    iget-object v2, p0, Lw/j$a;->a:Lw/j;

    invoke-static {v2}, Lw/j;->a(Lw/j;)Lw/j$h;

    move-result-object v2

    invoke-interface {v2, p1}, Lw/j$h;->m(Lw/j$e;)Ljava/lang/CharSequence;
    ...
    invoke-interface {p2, v2}, Lx/i$d;->b(Ljava/lang/Object;)V
    ...
    invoke-interface {p1}, Lw/j$h;->a()V
    ...
    invoke-interface {v1, p1}, Lw/j$h;->e(Z)V
    :try_end_3
    ...
    invoke-static {v1, p1}, Lw/j;->f(Lw/j;Lorg/json/JSONObject;)Lw/j$j;
    ...
    invoke-interface {v1, p1}, Lw/j$h;->f(Lw/j$j;)V
    ...
    invoke-interface {p1}, Lw/j$h;->c()V
    ...
    invoke-interface {p1}, Lw/j$h;->b()V
    :try_end_5
    ...
    invoke-static {v1, p1}, Lw/j;->e(Lw/j;Ljava/lang/String;)Lw/j$k;
    ...
    invoke-interface {v1, p1}, Lw/j$h;->i(Lw/j$k;)V
    ...
    invoke-static {v1, p1}, Lw/j;->d(Lw/j;Lorg/json/JSONArray;)Ljava/util/List;
    ...
    invoke-interface {v1, p1}, Lw/j$h;->k(Ljava/util/List;)V
    ...
    invoke-static {v1, p1}, Lw/j;->c(Lw/j;Lorg/json/JSONObject;)Lw/j$c;
    ...
    invoke-interface {v1, p1}, Lw/j$h;->n(Lw/j$c;)V
    ...
    invoke-static {v1, p1}, Lw/j;->b(Lw/j;Lorg/json/JSONArray;)I
    ...
    invoke-interface {v1, p1}, Lw/j$h;->g(I)V
    ...
    invoke-static {p1}, Lw/j$g;->a(Ljava/lang/String;)Lw/j$g;
    ...
    invoke-interface {v1, p1}, Lw/j$h;->j(Lw/j$g;)V
    ...
    invoke-static {p1}, Lw/j$i;->a(Ljava/lang/String;)Lw/j$i;
    ...
    invoke-interface {v1, p1}, Lw/j$h;->h(Lw/j$i;)V
