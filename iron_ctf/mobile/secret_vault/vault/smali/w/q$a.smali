...
.method public a(Lx/h;Lx/i$d;)V
    ...
    iget-object v4, v1, Lw/q$a;->a:Lw/q;

    invoke-static {v4}, Lw/q;->a(Lw/q;)Lw/q$f;
    ...
    :cond_0
    iget-object v4, v0, Lx/h;->a:Ljava/lang/String;
    ...
    invoke-static {v6, v5}, Ll/b;->f(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface/range {p2 .. p2}, Lx/i$d;->c()V

    goto/16 :goto_5

    :pswitch_0
    iget-object v0, v1, Lw/q$a;->a:Lw/q;

    invoke-static {v0}, Lw/q;->a(Lw/q;)Lw/q$f;

    move-result-object v0

    invoke-interface {v0}, Lw/q$f;->f()V
    ...
    invoke-interface {v0}, Lw/q$f;->b()V

    goto/16 :goto_3

    :pswitch_2
    iget-object v3, v1, Lw/q$a;->a:Lw/q;

    invoke-static {v3}, Lw/q;->a(Lw/q;)Lw/q$f;
    ...
    invoke-interface {v3, v0}, Lw/q$f;->i(Z)V
    ...
    invoke-interface/range {v9 .. v14}, Lw/q$f;->e(DD[D)V

    invoke-interface {v2, v6}, Lx/i$d;->b(Ljava/lang/Object;)V
    ...
    invoke-interface {v0, v5, v7}, Lw/q$f;->a(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-interface {v0}, Lw/q$f;->c()V
    ...
    invoke-interface {v0}, Lw/q$f;->j()V
    ...
    iget-object v5, v1, Lw/q$a;->a:Lw/q;

    invoke-static {v5}, Lw/q;->a(Lw/q;)Lw/q$f;

    move-result-object v5

    invoke-static {v0}, Lw/q$b;->a(Lorg/json/JSONObject;)Lw/q$b;

    move-result-object v0

    invoke-interface {v5, v3, v0}, Lw/q$f;->h(ILw/q$b;)V
    ...
    invoke-interface {v2, v4, v0, v6}, Lx/i$d;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v0}, Lw/q$e;->a(Lorg/json/JSONObject;)Lw/q$e;

    move-result-object v0

    invoke-interface {v3, v0}, Lw/q$f;->g(Lw/q$e;)V
    ...
    invoke-interface {v5, v3, v0}, Lw/q$f;->d(IZ)V
