...
.method private final addListener(Ljava/util/concurrent/Executor;Lg/a;Lu0/b;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p1}, Lr0/d1;->a(Ljava/util/concurrent/Executor;)Lr0/f0;

    move-result-object p1

    invoke-static {p1}, Lr0/j0;->a(Ld0/g;)Lr0/i0;
    ...
    invoke-direct {v4, p3, p2, v5}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter$addListener$1$1;-><init>(Lu0/b;Lg/a;Ld0/d;)V

    const/4 v5, 0x3

    const/4 v6, 0x0

    invoke-static/range {v1 .. v6}, Lr0/g;->b(Lr0/i0;Ld0/g;Lr0/k0;Lk0/p;ILjava/lang/Object;)Lr0/k1;
...
.method private final removeListener(Lg/a;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v1, v3, v2, v3}, Lr0/k1$a;->a(Lr0/k1;Ljava/util/concurrent/CancellationException;ILjava/lang/Object;)V
...
# virtual methods
.method public final addWindowLayoutInfoListener(Landroid/app/Activity;Ljava/util/concurrent/Executor;Lg/a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v0, p1}, Landroidx/window/layout/WindowInfoTracker;->windowLayoutInfo(Landroid/app/Activity;)Lu0/b;

    move-result-object p1

    invoke-direct {p0, p2, p3, p1}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter;->addListener(Ljava/util/concurrent/Executor;Lg/a;Lu0/b;)V

    return-void
.end method

.method public final removeWindowLayoutInfoListener(Lg/a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter;->removeListener(Lg/a;)V
