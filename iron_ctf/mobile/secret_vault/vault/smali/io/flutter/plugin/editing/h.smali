...
.field private final d:Lio/flutter/plugin/editing/i;
...
.field private final m:Lio/flutter/plugin/editing/h$a;

.field private n:I


# direct methods
.method public constructor <init>(Landroid/view/View;ILw/q;Lio/flutter/plugin/editing/h$a;Lio/flutter/plugin/editing/i;Landroid/view/inputmethod/EditorInfo;)V
    .locals 8
    ...
    invoke-direct/range {v0 .. v7}, Lio/flutter/plugin/editing/h;-><init>(Landroid/view/View;ILw/q;Lio/flutter/plugin/editing/h$a;Lio/flutter/plugin/editing/i;Landroid/view/inputmethod/EditorInfo;Lio/flutter/embedding/engine/FlutterJNI;)V

    return-void
.end method

.method public constructor <init>(Landroid/view/View;ILw/q;Lio/flutter/plugin/editing/h$a;Lio/flutter/plugin/editing/i;Landroid/view/inputmethod/EditorInfo;Lio/flutter/embedding/engine/FlutterJNI;)V
    .locals 8
    ...
    iput-boolean v0, p0, Lio/flutter/plugin/editing/h;->g:Z

    new-instance v1, Landroid/view/inputmethod/ExtractedText;

    invoke-direct {v1}, Landroid/view/inputmethod/ExtractedText;-><init>()V

    iput-object v1, p0, Lio/flutter/plugin/editing/h;->i:Landroid/view/inputmethod/ExtractedText;

    iput v0, p0, Lio/flutter/plugin/editing/h;->n:I

    iput-object p1, p0, Lio/flutter/plugin/editing/h;->a:Landroid/view/View;

    iput p2, p0, Lio/flutter/plugin/editing/h;->b:I

    iput-object p3, p0, Lio/flutter/plugin/editing/h;->c:Lw/q;

    iput-object p5, p0, Lio/flutter/plugin/editing/h;->d:Lio/flutter/plugin/editing/i;

    invoke-virtual {p5, p0}, Lio/flutter/plugin/editing/i;->a(Lio/flutter/plugin/editing/i$b;)V

    iput-object p6, p0, Lio/flutter/plugin/editing/h;->e:Landroid/view/inputmethod/EditorInfo;

    iput-object p4, p0, Lio/flutter/plugin/editing/h;->m:Lio/flutter/plugin/editing/h$a;
    ...
    iput-object p2, p0, Lio/flutter/plugin/editing/h;->l:Lio/flutter/plugin/editing/a;
    ...
    iput-object p2, p0, Lio/flutter/plugin/editing/h;->k:Landroid/text/Layout;
    ...
    iput-object p1, p0, Lio/flutter/plugin/editing/h;->j:Landroid/view/inputmethod/InputMethodManager;
...
.method private b(I)Z
    ...
    iget-object p1, p0, Lio/flutter/plugin/editing/h;->d:Lio/flutter/plugin/editing/i;

    invoke-virtual {p1}, Landroid/text/SpannableStringBuilder;->length()I

    move-result p1

    invoke-virtual {p0, v1, p1}, Lio/flutter/plugin/editing/h;->setSelection(II)Z
    ...
    iget-object v1, p0, Lio/flutter/plugin/editing/h;->d:Lio/flutter/plugin/editing/i;
    ...
    iget-object v2, p0, Lio/flutter/plugin/editing/h;->d:Lio/flutter/plugin/editing/i;
    ...
    iget-object v3, p0, Lio/flutter/plugin/editing/h;->d:Lio/flutter/plugin/editing/i;
...
.method private c()Landroid/view/inputmethod/CursorAnchorInfo;
    ...
    :cond_0
    iget-object v0, p0, Lio/flutter/plugin/editing/h;->h:Landroid/view/inputmethod/CursorAnchorInfo$Builder;
    ...
    iput-object v0, p0, Lio/flutter/plugin/editing/h;->h:Landroid/view/inputmethod/CursorAnchorInfo$Builder;
    ...
    iget-object v0, p0, Lio/flutter/plugin/editing/h;->d:Lio/flutter/plugin/editing/i;
    ...
    iget-object v2, p0, Lio/flutter/plugin/editing/h;->h:Landroid/view/inputmethod/CursorAnchorInfo$Builder;
...
.method private d(Landroid/view/inputmethod/ExtractedTextRequest;)Landroid/view/inputmethod/ExtractedText;
    ...
    iget-object v0, p0, Lio/flutter/plugin/editing/h;->i:Landroid/view/inputmethod/ExtractedText;
    ...
    iget-object p1, p0, Lio/flutter/plugin/editing/h;->i:Landroid/view/inputmethod/ExtractedText;
...
.method private e(ZZ)Z
    ...
    iget-object p1, p0, Lio/flutter/plugin/editing/h;->l:Lio/flutter/plugin/editing/a;
...
.method private g(ZZ)Z
    ...
    iget-object p2, p0, Lio/flutter/plugin/editing/h;->k:Landroid/text/Layout;
    ...
    iget-object p2, p0, Lio/flutter/plugin/editing/h;->d:Lio/flutter/plugin/editing/i;
...
.method public a(ZZZ)V
    ...
    iget-object v0, p0, Lio/flutter/plugin/editing/h;->j:Landroid/view/inputmethod/InputMethodManager;
    ...
    :cond_0
    iget-object p1, p0, Lio/flutter/plugin/editing/h;->f:Landroid/view/inputmethod/ExtractedTextRequest;

    if-eqz p1, :cond_1

    iget-object p2, p0, Lio/flutter/plugin/editing/h;->j:Landroid/view/inputmethod/InputMethodManager;
    ...
    invoke-direct {p0, p1}, Lio/flutter/plugin/editing/h;->d(Landroid/view/inputmethod/ExtractedTextRequest;)Landroid/view/inputmethod/ExtractedText;
    ...
    :cond_1
    iget-boolean p1, p0, Lio/flutter/plugin/editing/h;->g:Z

    if-eqz p1, :cond_2

    invoke-direct {p0}, Lio/flutter/plugin/editing/h;->c()Landroid/view/inputmethod/CursorAnchorInfo;
    ...
    invoke-static {p2, p3, p1}, Lio/flutter/plugin/editing/g;->a(Landroid/view/inputmethod/InputMethodManager;Landroid/view/View;Landroid/view/inputmethod/CursorAnchorInfo;)V
...
.method public beginBatchEdit()Z
    ...
    iget v0, p0, Lio/flutter/plugin/editing/h;->n:I
...
.method public commitContent(Landroid/view/inputmethod/InputContentInfo;ILandroid/os/Bundle;)Z
    ...
    invoke-direct {p0, v2, v0}, Lio/flutter/plugin/editing/h;->h(Ljava/io/InputStream;I)[B
    ...
    iget-object p2, p0, Lio/flutter/plugin/editing/h;->c:Lw/q;

    iget v0, p0, Lio/flutter/plugin/editing/h;->b:I

    invoke-virtual {p2, v0, v2}, Lw/q;->b(ILjava/util/Map;)V
...
.method public endBatchEdit()Z
    ...
    iget v1, p0, Lio/flutter/plugin/editing/h;->n:I

    add-int/lit8 v1, v1, -0x1

    iput v1, p0, Lio/flutter/plugin/editing/h;->n:I
...
.method public f(Landroid/view/KeyEvent;)Z
    ...
    invoke-direct {p0, v3, p1}, Lio/flutter/plugin/editing/h;->e(ZZ)Z
    ...
    invoke-direct {p0, v1, p1}, Lio/flutter/plugin/editing/h;->e(ZZ)Z
    ...
    invoke-direct {p0, v3, p1}, Lio/flutter/plugin/editing/h;->g(ZZ)Z
    ...
    invoke-direct {p0, v1, p1}, Lio/flutter/plugin/editing/h;->g(ZZ)Z
    ...
    iget-object v2, p0, Lio/flutter/plugin/editing/h;->e:Landroid/view/inputmethod/EditorInfo;
...
.method public getExtractedText(Landroid/view/inputmethod/ExtractedTextRequest;I)Landroid/view/inputmethod/ExtractedText;
    ...
    :goto_0
    iget-object v2, p0, Lio/flutter/plugin/editing/h;->f:Landroid/view/inputmethod/ExtractedTextRequest;
    ...
    invoke-static {v1, v0}, Ll/b;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_3
    iput-object p2, p0, Lio/flutter/plugin/editing/h;->f:Landroid/view/inputmethod/ExtractedTextRequest;
...
.method public performContextMenuAction(I)Z
    ...
    invoke-direct {p0, p1}, Lio/flutter/plugin/editing/h;->b(I)Z
...
.method public performEditorAction(I)Z
    ...
    iget-object p1, p0, Lio/flutter/plugin/editing/h;->c:Lw/q;

    iget v1, p0, Lio/flutter/plugin/editing/h;->b:I

    invoke-virtual {p1, v1}, Lw/q;->e(I)V
    ...
    invoke-virtual {p1, v1}, Lw/q;->k(I)V
    ...
    invoke-virtual {p1, v1}, Lw/q;->h(I)V
    ...
    invoke-virtual {p1, v1}, Lw/q;->n(I)V
    ...
    invoke-virtual {p1, v1}, Lw/q;->m(I)V
    ...
    invoke-virtual {p1, v1}, Lw/q;->f(I)V
    ...
    invoke-virtual {p1, v1}, Lw/q;->g(I)V
    ...
    invoke-virtual {p1, v1}, Lw/q;->p(I)V
...
.method public performPrivateCommand(Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    iget-object v0, p0, Lio/flutter/plugin/editing/h;->c:Lw/q;

    iget v1, p0, Lio/flutter/plugin/editing/h;->b:I

    invoke-virtual {v0, v1, p1, p2}, Lw/q;->j(ILjava/lang/String;Landroid/os/Bundle;)V
...
.method public requestCursorUpdates(I)Z
    ...
    invoke-static {v0, v2, v3}, Lio/flutter/plugin/editing/g;->a(Landroid/view/inputmethod/InputMethodManager;Landroid/view/View;Landroid/view/inputmethod/CursorAnchorInfo;)V
    ...
    invoke-static {v2, p1}, Ll/b;->a(Ljava/lang/String;Ljava/lang/String;)V

    :cond_4
    iput-boolean v1, p0, Lio/flutter/plugin/editing/h;->g:Z
...
.method public sendKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    iget-object v0, p0, Lio/flutter/plugin/editing/h;->m:Lio/flutter/plugin/editing/h$a;
