...
.field private deferredComponentManager:Ln/a;
...
.method public static decodeImage(Ljava/nio/ByteBuffer;J)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p2, p0}, Ll/b;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private handlePlatformMessageResponse(ILjava/nio/ByteBuffer;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Lm/d;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1, p2}, Lm/d;->c(ILjava/nio/ByteBuffer;)V
...
.method public computePlatformResolvedLocale([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Ly/d;
    ...
    :cond_5
    iget-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Ly/d;

    invoke-virtual {p1, v0}, Ly/d;->c(Ljava/util/List;)Ljava/util/Locale;
    ...
    invoke-static {p1}, Lio/flutter/embedding/engine/f;->a(Ljava/util/Locale;)Ljava/lang/String;
...
.method public dispatchEmptyPlatformMessage(Ljava/lang/String;I)V
    ...
    invoke-static {p2, p1}, Ll/b;->g(Ljava/lang/String;Ljava/lang/String;)V
...
.method public dispatchSemanticsAction(ILio/flutter/view/k$g;)V
    .locals 1

    const/4 v0, 0x0

    invoke-virtual {p0, p1, p2, v0}, Lio/flutter/embedding/engine/FlutterJNI;->dispatchSemanticsAction(ILio/flutter/view/k$g;Ljava/lang/Object;)V

    return-void
.end method

.method public dispatchSemanticsAction(ILio/flutter/view/k$g;Ljava/lang/Object;)V
    .locals 1
    ...
    invoke-virtual {v0, p3}, Lx/o;->b(Ljava/lang/Object;)Ljava/nio/ByteBuffer;
    ...
    :goto_0
    iget p2, p2, Lio/flutter/view/k$g;->d:I
...
.method public getScaledFontSize(FI)F
    ...
    invoke-static {p2}, Lw/n;->b(I)Landroid/util/DisplayMetrics;
...
.method public handlePlatformMessage(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
    ...
    invoke-interface/range {v0 .. v5}, Lm/d;->d(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
...
.method public invokePlatformMessageEmptyResponseCallback(I)V
    ...
    invoke-static {v0, p1}, Ll/b;->g(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public requestDartDeferredLibrary(I)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->deferredComponentManager:Ln/a;

    if-eqz v0, :cond_0

    const/4 v1, 0x0

    invoke-interface {v0, p1, v1}, Ln/a;->c(ILjava/lang/String;)V
...
.method public setDeferredComponentManager(Ln/a;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->deferredComponentManager:Ln/a;

    if-eqz p1, :cond_0

    invoke-interface {p1, p0}, Ln/a;->f(Lio/flutter/embedding/engine/FlutterJNI;)V

    :cond_0
    return-void
.end method

.method public setLocalizationPlugin(Ly/d;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Ly/d;

    return-void
.end method

.method public setPlatformMessageHandler(Lm/d;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Lm/d;
...
.method public spawn(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)Lio/flutter/embedding/engine/FlutterJNI;
    ...
    invoke-static {p2, p3}, La0/f;->a(ZLjava/lang/Object;)V
