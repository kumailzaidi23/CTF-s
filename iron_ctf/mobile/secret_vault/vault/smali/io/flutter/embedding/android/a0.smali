...
.method public constructor <init>(Lx/b;)V
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/a0;->a:Lx/b;
...
.method private static e(Landroid/view/KeyEvent;)Lio/flutter/embedding/android/w$a;
    .locals 2
    ...
    sget-object p0, Lio/flutter/embedding/android/w$a;->f:Lio/flutter/embedding/android/w$a;
    ...
    sget-object p0, Lio/flutter/embedding/android/w$a;->g:Lio/flutter/embedding/android/w$a;

    goto :goto_1

    :cond_3
    sget-object p0, Lio/flutter/embedding/android/w$a;->e:Lio/flutter/embedding/android/w$a;
...
.method private i(Landroid/view/KeyEvent;Lio/flutter/embedding/android/b0$d$a;)Z
    ...
    :goto_5
    sget-object v0, Lio/flutter/embedding/android/w$a;->e:Lio/flutter/embedding/android/w$a;
    ...
    sget-object v0, Lio/flutter/embedding/android/w$a;->g:Lio/flutter/embedding/android/w$a;
    ...
    :goto_7
    sget-object v2, Lio/flutter/embedding/android/w$a;->g:Lio/flutter/embedding/android/w$a;
    ...
    :cond_d
    sget-object v2, Lio/flutter/embedding/android/w$a;->e:Lio/flutter/embedding/android/w$a;
    ...
    iput-object v0, v2, Lio/flutter/embedding/android/w;->b:Lio/flutter/embedding/android/w$a;
    ...
    iput-object v1, v2, Lio/flutter/embedding/android/w;->f:Ljava/lang/String;
...
.method private n(Lio/flutter/embedding/android/w;Lio/flutter/embedding/android/b0$d$a;)V
    ...
    :goto_0
    iget-object v0, p0, Lio/flutter/embedding/android/a0;->a:Lx/b;
...
.method private q(ZLjava/lang/Long;Ljava/lang/Long;J)V
    ...
    sget-object p4, Lio/flutter/embedding/android/w$a;->e:Lio/flutter/embedding/android/w$a;

    goto :goto_0

    :cond_0
    sget-object p4, Lio/flutter/embedding/android/w$a;->f:Lio/flutter/embedding/android/w$a;

    :goto_0
    iput-object p4, v0, Lio/flutter/embedding/android/w;->b:Lio/flutter/embedding/android/w$a;
    ...
    iput-object p4, v0, Lio/flutter/embedding/android/w;->f:Ljava/lang/String;
...
.method o(Lio/flutter/embedding/android/c0$d;ZJJLandroid/view/KeyEvent;Ljava/util/ArrayList;)V
    ...
    invoke-static/range {p7 .. p7}, Lio/flutter/embedding/android/a0;->e(Landroid/view/KeyEvent;)Lio/flutter/embedding/android/w$a;
