...
.method public constructor <init>(Landroid/content/Context;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lo/d;->k(Landroid/content/Context;)V

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p1

    invoke-virtual {v0, p1, p2}, Lo/d;->f(Landroid/content/Context;[Ljava/lang/String;)V
...
.method public a(Lio/flutter/embedding/engine/d$b;)Lio/flutter/embedding/engine/a;
    ...
    invoke-virtual {p1}, Lio/flutter/embedding/engine/d$b;->c()Lm/a$b;
    ...
    invoke-virtual {p1}, Lio/flutter/embedding/engine/a;->n()Lw/i;

    move-result-object v0

    invoke-virtual {v0, v3}, Lw/i;->c(Ljava/lang/String;)V

    :cond_2
    invoke-virtual {p1}, Lio/flutter/embedding/engine/a;->j()Lm/a;

    move-result-object v0

    invoke-virtual {v0, v2, v4}, Lm/a;->g(Lm/a$b;Ljava/util/List;)V
    ...
    invoke-virtual/range {v0 .. v7}, Lio/flutter/embedding/engine/a;->x(Landroid/content/Context;Lm/a$b;Ljava/lang/String;Ljava/util/List;Lio/flutter/plugin/platform/x;ZZ)Lio/flutter/embedding/engine/a;
